...
public class ReversedDepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAArithmExpression(AArithmExpression node)
    {
        defaultIn(node);
    }

    public void outAArithmExpression(AArithmExpression node)
    {
        defaultOut(node);
    }

    public void caseAArithmExpression(AArithmExpression node)
    {
        inAArithmExpression(node);
        if(node.getBinop() != null)
        {
            node.getBinop().apply(this);
        }
    ...
    public void inAAddoneBinop(AAddoneBinop node)
    {
        defaultIn(node);
    }

    public void outAAddoneBinop(AAddoneBinop node)
    {
        defaultOut(node);
    }

    public void caseAAddoneBinop(AAddoneBinop node)
    {
        inAAddoneBinop(node);
        if(node.getDplus() != null)
        {
            node.getDplus().apply(this);
        }
        outAAddoneBinop(node);
    }
    ...
    public void inAMinusoneBinop(AMinusoneBinop node)
    {
        defaultIn(node);
    }

    public void outAMinusoneBinop(AMinusoneBinop node)
    {
        defaultOut(node);
    }

    public void caseAMinusoneBinop(AMinusoneBinop node)
    {
        inAMinusoneBinop(node);
        if(node.getDminus() != null)
        {
            node.getDminus().apply(this);
        }
        outAMinusoneBinop(node);
    }
